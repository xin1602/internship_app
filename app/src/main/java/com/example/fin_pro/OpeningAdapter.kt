...
class OpeningAdapter(private var jobs: List<Job>) : RecyclerView.Adapter<OpeningAdapter.JobViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): JobViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.adapter_opening, parent, false)
        ...
        holder.ib_fav.setOnClickListener {
            ...
            Thread {
                ...
                if (isJobFavorite) {
                    ...
                    holder.itemView.post {
                        Toast.makeText(holder.itemView.context, "移除收藏", Toast.LENGTH_SHORT)
                            .show()
                    }
