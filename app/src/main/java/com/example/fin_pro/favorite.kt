...
class favorite : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Thread {
            ...
            val favorites = con.getFavorite(userId!!)
        ...
        spinner_1.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parentView: AdapterView<*>?, selectedItemView: View?, position: Int, id: Long) {
                ...
                Thread {
                    ...
                    val getFavorite = con.getFavorite(userId!!)
                    val filteredJobs = filterJobs(getFavorite, selectedArea, selectedDepartment)

                    // 更新 Adapter 的資料集
                    runOnUiThread {
                        val adapter = FavoriteAdapter(filteredJobs)
                        recyclerView.adapter = adapter
                    }
                }.start()
            }
